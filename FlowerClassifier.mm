...
//  Copyright © 2017 Alexandra Stroulger. All rights reserved.
//
...
NSString* FilePathForResourceName(NSString* name, NSString* extension) {
    //    NSString* file_path = @"/Users/alex/Learning/machine-learning/tensorflow/tensorflow/examples/ios/simple/data/flower_retrained.pb";
...
NSDictionary* RunInferenceOnImage(UIImage* image) {
    ...
    NSString* network_path = FilePathForResourceName(@"flowers_quantized_graph", @"pb");
    ...
    // Read the label list
    NSString* labels_path = FilePathForResourceName(@"flower_retrained_labels", @"txt");
    ...
    if (!image) {
        NSString* image_path = FilePathForResourceName(@"roses", @"jpg");
        image_data = LoadImageFromFile( [image_path UTF8String], &image_width,
                                                                      &image_height, &image_channels);
    } else {
        image_data = LoadImage(image.CGImage, &image_width,
                               &image_height, &image_channels);
    }
